pipeline {
     environment {
       ...
       APP_NAME = "ulrich"
       STG_API_ENDPOINT = "ip10-0-14-4-d2cb8r657ed000cojo1g-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-14-4-d2cb8r657ed000cojo1g-80.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "http://ip10-0-14-5-d2cb8r657ed000cojo1g-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "http://ip10-0-14-5-d2cb8r657ed000cojo1g-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "5000"
